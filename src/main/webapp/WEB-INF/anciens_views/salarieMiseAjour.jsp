  ...
  <!-- START PAGE CONTAINER -->
        <div class="page-container">
            ...
            <!-- PAGE CONTENT WRAPPER chauffeur -->
                ...
                <f:form method="POST" action="updateSalarieChauffeur"  modelAttribute="modelChauffeur" class="form-horizontal">
                                      ...
                                      <div class="form-group">                                        
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input path="carte_sejour" name="carte_sejour"  id="carte_sejour2" class="form-control"required="required" value="${salarieToUpC.carte_sejour}"/>
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="password" path="pass" name="pass" class="form-control" value="${salarieToUpC.pass}"/>
                                                    </div>            
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                           <input type="date" path="dateEntree"  name="dateEntree" required="required" class="form-control datepicker"  value="${salarieToUpC.date_travail}"/>                                            
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        <input type="date" path="date" name="date_naissance" value="${salarieToUpC.date_naissance}" required="required" class="form-control datepicker" />                                            
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">                                        
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input path="login" name="login" value="${salarieToUpC.login}" class="form-control"required="required"/>
                                               ...
                                               <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-unlock-alt"></span></span>
                                                        <input type="password" path="pass" name="passConf" class="form-control"/>
                                                    </div>            
  										...
  										<div class="form-group">
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        <input type="date" path="date"  path="dateSortie" name="dateSortie" id="dateSortie"  value="${salarieToUpC.sortieTravail}" required="required" class="form-control datepicker" />                                            
                                                    </div>
                                                </div>
                                            </div>
                                             ...
                                             <div class="form-group">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input path="compteBancaire" name="compteBancaire"  type="text" class="form-control" required="required" value="${salarieToUpC.compteBancaire}"/>
