    ...
    <div id="edit-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Modifier les paramètres de prime</h4>
                </div>          
              
               <f:form method="post" name="form" action="validerUpdatePrimesParam" class="form-horizontal">
       ...
       <table>
										  ...
										  <td>Primes  :</td>
										     ...
										     <label  name="nomPrimeVariable" id="nomPrimeVariable" path="nomPrimeVariable" class="form-control" />
										  </td>
										  </tr>
										  ...
										  <td>Avantages en natures  :</td>
										      <td>
										    <input type="hidden"  id="id" name="idPrimesPara"/>
        ...
        //	$modal.find('#idIgr').val('test');
            ...
            $.ajax({
                ...
                {   
                	...
                	$modal.find('#id').val(data.idPrimeVariable);
