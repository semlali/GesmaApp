...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    <a href="AjouterSalarie">Ajouter salarié</a>
...
<f:form method="POST" action="AjouteFonction" >
     <fieldset>
    <legend>Ajout d'une Profession :</legend>

<table>

    <tr>
        <td><label path="nomProfession" >Nom de Profession :</label></td>
        <td><input path="nomProfession" name="nomProfession" /></td>
