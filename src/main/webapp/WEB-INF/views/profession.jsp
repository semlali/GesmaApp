...
<body>
        ...
        <div class="page-container">
                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-openable">
                        ...
                        <ul>
                            ...
                            <li><a href="pages-address-book.html"><span class="fa fa-users"></span> Gestion des Salariés</a></li>
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Gestion des Professions</li>
                </ul>
                <!-- END BREADCRUMB -->                       
 ...
 <!-- PAGE CONTENT WRAPPER -->
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <f:form class="form-horizontal" method="POST" action="AjouteFonction"  >
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Ajouter Votre Profession :</strong> </h3>
                                ...
                                <div class="panel-body">                                                                        
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                 <input type="text" path="nomProfession" class="form-control" name="nomProfession" />
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Code Profession </label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                 <input type="number" path="codeProfession" name="codeProfession" class="form-control" name="" />
                                ...
                                <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label"> Profession arabe </label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                 <input type="text" path="nomProfession_arabe" class="form-control" name="nomProfession_arabe" />
