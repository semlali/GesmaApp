  ...
  <!-- START PAGE CONTAINER -->
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Gestion d'IGR</li>
                </ul>
                <!-- END BREADCRUMB -->  
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title">les paramètres d'IGR :</h3>
                                                    ...
                                                    <c:forEach items="${ir}" var="i" >
        												<tr>
														     ...
														     <td><label path="taux" value="${i.sommeADeduire}" >${i.sommeADeduire}</label></td>
														      <td><a class="btn btn-default btn-rounded btn-sm"  data-toggle="modal" id="${i.idIgr}" data-target="#edit-modal" ><span class="fa fa-pencil"></span></a>
														     <a href="SupprimerIGR?getIdToDelete=${i.idIgr}" class="btn btn-danger btn-rounded btn-sm" onclick="return confirm('Etes vous sur de vouloir supprimer cette ligne ?')"><span class="fa fa-times"></span></a>
														    </td>
    ...
    <div id="edit-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Modifier les paramètres d'IR</h4>
                </div>          
                   ...
                   <f:form method="post" name="form" action="validerUpdateIGR" modelAttribute="IGRModel">
       ...
       <table>
										  ...
										  <td>Debut tranche :</td>
										      <td>
										     <input name="debutTranche" id="debutTranche" path="debutTranche"    />
										  </td>
										  </tr>
										   <tr>
										   <td>
										   Fin tranche
										       ...
										       <td>
										     <input name="finTranche"  id="finTranche" path="finTranche" />
										  </td>
										  </tr>
										  <tr>
										  <td>
										  Taux :
										      ...
										      <td>
										     <input name="taux"  path="taux"  id="taux" />
										     </td>
										</tr>
										 <tr>
										 <td> 
										 Somme à déduire :
										     ...
										     <td>
										     <input name="sommeADeduire"  id="sommeADeduire" path="sommeADeduire"   />
									    	 <input type="hidden" name="idIgr" id="id"/>
									    	</td>
										</tr>
    ...
    <div id="add-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
              ...
              <!-- my form to add -->
               ...
               <f:form action="ajouterIGR"  method="POST">
       ...
       <table>
										  ...
										  <td>Debut tranche :</td>
										      <td>
										     <input name="debutTranche"  path="debutTranche" />
										  </td>
										  </tr>
										   <tr>
										   <td>
										   Fin tranche
										       ...
										       <td>
										     <input name="finTranche"  path="finTranche"  />
										  </td>
										  </tr>
										  <tr>
										  <td>
										 ...
										 Somme à déduire :
										     ...
										     <td>
										     <input name="sommeADeduire"  path="taux"  />
									    	</td>
										</tr>
...
<script>
        ...
        //	$modal.find('#idIgr').val('test');
            ...
            $.ajax({
                ...
                {   
                	$modal.find('#debutTranche').val(data.debutTranche);
                	$modal.find('#finTranche').val(data.finTranche);
                	$modal.find('#sommeADeduire').val(data.sommeADeduire);
                	$modal.find('#taux').val(data.taux);
                	$modal.find('#id').val(data.idIgr);
