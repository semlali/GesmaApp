        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Gestion de banque</li>
                </ul>
                <!-- END BREADCRUMB -->                       
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <f:form class="form-horizontal"  method="POST" action="AjouterBanque" modelAttribute="banqueModel" >
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><center></center><strong>Ajouter Votre Banque </strong> </center></h3>
                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Nom de la Banque</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" path="nomProfession" class="form-control" name="nomBanque" />
                                            </div>                                            
                                            
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Adresse de la Banque</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" path="adresseBanque" name="adresseBanque"/>
                                            </div>                                            
                                     ...
                                     <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Faxe de la Banque</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input class="form-control"  pattern="^((\+\d{1,3}(-| )?\(?\d\)?(-| )?\d{1,5})|(\(?\d{2,6}\)?))(-| )?(\d{3,4})(-| )?(\d{4})(( x| ext)\d{1,5}){0,1}$" path="faxeBanque" name="faxeBanque" /> </div>                                            
                                            
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Telephone de la Banque</label>
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                 <input  pattern="^((\+\d{1,3}(-| )?\(?\d\)?(-| )?\d{1,5})|(\(?\d{2,6}\)?))(-| )?(\d{3,4})(-| )?(\d{4})(( x| ext)\d{1,5}){0,1}$" class="form-control" path="telBanque" name="telBanque" />  </div>                                            
                                ...
                                <div class="panel-footer">
                                    ...
                                    <input path=""  type="submit"  value="Enregistrer" class="btn btn-primary pull-right"/>
