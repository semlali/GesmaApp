                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title">les paramètres d'Anciennete :</h3>
                                                    ...
                                                    <c:forEach  items="${anciennete}" var="a" >
        												...
        												<td><label path="debutTranche" value="${a.debutTranche}" >${a.debutTranche}</label></td>
													     ...
													     <td><label path="taux" value="${a.tauxAnciennete}" >${a.tauxAnciennete}</label></td>
     												     <td><a href="#myModal" data-toggle="modal" id="${a.idAnciennete}" data-target="#edit-modal"  role="button" class="btn btn-default btn-rounded btn-sm"><span class="fa fa-pencil"></span></a>
     												     <a href="SupprimerAnciennete?getIdToDelete=${a.idAnciennete}" class="btn btn-danger btn-rounded btn-sm" onclick="return confirm('Etes vous sur de vouloir supprimer cette ligne ?')"><span class="fa fa-times"></span></a> </td>
	...
	<div id="edit-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Modifier les paramètres d'ancienneté</h4>
                </div>
       ...
       <table>
										  ...
										  <td> Debut de tranche :</td>
										   ...
										   <td> Fin tranche :</td>
										       <td>
										     <input name="finTranche"  path="finTranche" id="finTranche" />
										  </td>
										  </tr>
										  <tr>
										  <td> Taux:</td>
										      <td>
										     <input name="tauxAnciennete"  path="taux"  id="taux" />
										      <input type="hidden" id="id" name="idAnciennete"/>
    ...
    <div id="add-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="myModalLabel">Ajouter nouveaux paramètres d'ancienneté</h4>
                </div>          
              ...
              <!-- my form to add -->
               ...
               <f:form action="ajouterAnciennete"  method="POST">
        ...
        //	$modal.find('#idIgr').val('test');
            ...
            $.ajax({
                ...
                {   
                    ...
                    $modal.find('#taux').val(data.tauxAnciennete);
                    $modal.find('#id').val(data.idAnciennete);
