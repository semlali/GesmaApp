        ...
        <div class="login-container">
            ...
            <div class="login-box animated fadeInDown">
                ...
                <div class="login-body">
                    <div class="login-title"><strong>${message}</strong><br>Log In to your account</div>
                    
                    <form action="SeConnecter" class="form-horizontal" method="get">
                    <div class="form-group">
                        <div class="col-md-12">
                            <input type="text" class="form-control" name="nom" placeholder="login"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
