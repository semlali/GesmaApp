        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span>Gestion des frais</h2>
                </div>
                <!-- END PAGE TITLE -->                
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title">Tous les Frais de prestations</h3>
                                </div>
                                        ...
                                        <table class="table table-bordered table-striped table-actions">
                                            ...
                                            <c:forEach items="${niveauFrais}" var="nf">                                           
                                                <tr id="trow_1">
                                                    ...
                                                    <td>
                                                        <a class="btn btn-default btn-rounded btn-sm"  data-toggle="modal" id="${nf.id_frais_niveau}" data-target="#edit-modal" ><span class="fa fa-pencil"></span></a>
                                                        <a class="btn btn-danger btn-rounded btn-sm" href="delete?getId=${nf.id_frais_niveau}" onclick="return confirm('Are you sure you want to delete?')"><span class="fa fa-times"></span></a>
