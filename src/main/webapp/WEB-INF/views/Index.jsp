...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/front-end/css/revolution-slider/extralayers.css" media="screen" />
        <link rel="stylesheet" type="text/css" href="resources/front-end/css/revolution-slider/settings.css" media="screen" />
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-header">
                ...
                <div class="page-header-holder">
                    ...
                    <!-- page logo -->
                    <div class="logo">
                        <a href="Index.jsp">Atlant - Front-end Template</a>
                    </div>
                    <!-- ./page logo -->
                    ...
                    <ul class="navigation">
                        <li>
                            ...
                            <ul>
                                <li><a href="Index.jsp">With Slider</a></li>
                        ...
                        <li><a href="connexion">Admin espace</a></li>
                        ...
                        <ul>
                                <li><a href="paiementParVirement">Paiement par virement bancaire</a></li>
                    ...
                    <div class="banner">
                        ...
                        <ul>
                            ...
                            <li data-transition="fade" data-slotamount="1" data-masterspeed="500"  data-saveperformance="on">
                                <img src="resources/front-end/img/backgrounds/bg-2.jpg" />
                                ...
                                <div class="tp-caption lft customout rs-parallaxlevel-0"
                                    ...
                                    style="z-index: 2;">
                                    <img src="resources/front-end/assets/slider-layers/atlant-title.png" alt="Atlant"/>
                                </div>
                                ...
                                <div class="tp-caption lft customout rs-parallaxlevel-0"
                                    ...
                                    data-endelementdelay="0.1"
                                    style="z-index: 3;">
                                    <img src="resources/front-end/assets/slider-layers/atlant_monitor.png" alt="Atlant"/>
                                </div>
                                ...
                                <div class="tp-caption black_thin_34 customin tp-resizeme rs-parallaxlevel-0"
                                    ...
                                    data-endelementdelay="0.1"
                                    style="z-index: 4;">
                                    <img src="resources/front-end/assets/slider-layers/atlant_responsive.png" alt="Atlant"/>
                                </div>
                                ...
                                <div class="tp-caption black_thin_34 customin tp-resizeme rs-parallaxlevel-0"
                                    ...
                                    data-endelementdelay="0.1"
                                    style="z-index: 5;">
                                    <img src="resources/front-end/assets/slider-layers/atlant_tempalte.png" alt="Atlant"/>
                                </div>
                                
                            </li>                                    
                                                        
                            <li data-transition="fade" data-slotamount="1" data-masterspeed="700" >
                                <img src="resources/front-end/assets/video/video_typing_cover.jpg"  alt="video_typing_cover"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat">                                
                                ...
                                <div class="tp-caption tp-fade fadeout fullscreenvideo"
                                    ...
                                    <video class="" preload="none" width="100%" height="100%" poster="assets/video/video_typing_cover.jpg"> 
                                        <source src='resources/front-end/assets/video/computer_typing.mp4' type='video/mp4'/>
                                        <source src='resources/front-end/assets/video/computer_typing.webm' type='video/webm'/>
                                    </video>
                                </div>
                                ...
                                <div class="tp-caption customin ltl"
                                        ...
                                        data-endeasing="Power4.easeIn"
                                        style="z-index: 3;">
                                        <img src="resources/front-end/assets/slider-layers/second_1.png"/>
                                </div>                                
                                ...
                                <div class="tp-caption customin ltl"
                                        ...
                                        data-endeasing="Power4.easeIn"
                                        style="z-index: 3;">
                                        <img src="resources/front-end/assets/slider-layers/second_2.png"/>
                                </div>
                                ...
                                <div class="tp-caption customin ltl"
                                        ...
                                        data-endeasing="Power4.easeIn"
                                        style="z-index: 3;">
                                        <img src="resources/front-end/assets/slider-layers/second_3.png"/>
                                </div>
                                ...
                                <div class="tp-caption customin ltl"
                                        ...
                                        data-endeasing="Power4.easeIn"
                                        style="z-index: 3;">
                                        <img src="resources/front-end/assets/slider-layers/second_4.png"/>
                                </div>
                                ...
                                <div class="tp-caption customin ltl"
                                        ...
                                        data-endeasing="Power4.easeIn"
                                        style="z-index: 3;">
                                        <img src="resources/front-end/assets/slider-layers/second_5.png"/>
                                </div>
                                ...
                                <div class="tp-caption customin ltl"
                                        ...
                                        data-endeasing="Power4.easeIn"
                                        style="z-index: 3;">
                                        <img src="resources/front-end/assets/slider-layers/second_6.png"/>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-8 this-animate" data-animate="fadeInLeft">
                                ...
                                <div class="block this-animate" data-animate="fadeInLeft">
                                    <img src="resources/front-end/assets/atlant_technologies.png" class="img-responsive"/>
                                </div>
                            </div>
                            <div class="col-md-4 this-animate text-center" data-animate="fadeInRight">
                                <img src="resources/front-end/assets/atlant_responsive.png" class="img-responsive-mobile"/>
                            </div>
                        </div>
        ...
        <script type="text/javascript" src="resources/front-end/js/plugins/revolution-slider/jquery.themepunch.tools.min.js"></script>
        <script type="text/javascript" src="resources/front-end/js/plugins/revolution-slider/jquery.themepunch.revolution.min.js"></script>
        
        <script type="text/javascript" src="resources/front-end/js/actions.js"></script>
        <script type="text/javascript" src="resources/front-end/js/slider.js"></script>
        <!-- ./page scripts -->
    </body>
</html>