                ...
                <ul class="x-navigation">
                    ...
                    <li class="xn-profile">
                        <a href="#" class="profile-mini">
                            <img src="resources/img/fond_gesma.jpg" alt="Gesma"/>
                        </a>
                        <div class="profile">
                            ...
                            <div class="profile-data">
                                <div class="profile-data-name">Gesma</div>
                                <div class="profile-data-title">MegacomSys</div>
                            </div>
                    ...
                    <li class="xn-openable">
                        ...
                        <ul>
                            ...
                            <li><a href="formFonction"><span class="fa fa-user"></span> Gestion des Profession</a></li>
                            <li><a href="formPrimes"><span class="fa fa-cogs"></span> Gestion des heures suplementaires et primes</a></li>
                             
                          
                           <li class="xn-openable">
                                <a href="#"><span class="fa fa-tasks" ></span> Gestion des Salariés </a>
                                
                                <ul>                                    
                                    <li><a href="formSalarie"><span class="fa fa-users"></span> Ajouter un salarié</a></li>
                                    <li><a href="updateSalarie"><span class="fa fa-users"></span> Update un salarié</a></li>
                          ...
                          <li class="xn-openable">
                                ...
                                <ul>                                    
                                    <li><a href="formPrimesParam"><span class="fa fa-copy"></span> Primes</a></li>
                                     <li><a href="formHeuresSupParam"><span class="fa fa-copy"></span> Heures supplémentaires </a></li>
                                     <li><a href="formIR"><span class="fa fa-file-o"></span>IGR</a></li>
                                    <li><a href="formAnciennete"><span class="fa fa-file-o"></span>Ancienneté</a></li>
                                    
                                </ul>
                          </li>
                      <li><a href="formFichePaie"><span class="fa fa-certificate"></span> Générer fiche de Paie</a></li>
