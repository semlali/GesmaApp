                                            ...
                                            <c:forEach  items="${vehicules}" var="v">                                           
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="ModifierVehicule?id_vehicule=${v.id_vehicule}" class="btn btn-default btn-rounded btn-sm"><span class="fa fa-pencil"></span> </a>
                                                         <button class="btn btn-default btn-rounded btn-sm" data-toggle="modal" data-target="#modal_basic"><span class="fa fa-pencil"></span></button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="defModalHead">Modifier les informations d'une véhicule</h4>
                    </div>
