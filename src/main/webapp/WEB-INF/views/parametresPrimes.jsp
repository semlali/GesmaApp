...
<body>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Gestion des primes</li>
                </ul>
                <!-- END BREADCRUMB -->  
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title">les paramètres des primes :</h3>
                                        ...
                                        <table class="table table-bordered table-striped table-actions">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th >Modifiers les paramètres</th>
                                                </tr>
                                            </thead>
                                            <tbody>                                            
                                           ...
                                           <!-- Je me suis arrte ici -->       
                                                    ...
                                                    <c:forEach items="${primesParam}" var="i" >
        												<tr>
       
														     <td><label class="col-md-3 control-label"  path="nomPrimeVariable" value="${i.nomPrimeVariable}" >${i.nomPrimeVariable}</label></td>
												 
												 		    
														   <td><a class="btn btn-default btn-rounded btn-sm"  data-toggle="modal" id="${i.idPrimeVariable}" data-target="#edit-modal" ><span class="fa fa-pencil"></span></a>
														     <a href="SupprimerPrimesParam?getIdToDelete=${i.idPrimeVariable}" class="btn btn-danger btn-rounded btn-sm" onclick="return confirm('Etes vous sur de vouloir supprimer cette ligne ?')"><span class="fa fa-times"></span></a>
														    </td>
    ...
    <div id="edit-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Modifier les paramètres des primes</h4>
                </div>          
              
              
              
               <f:form method="post" name="form" action="validerUpdatePrimesParam" modelAttribute="validationModel" class="form-horizontal">
       ...
       <table>
										  ...
										  <td>Primes  :</td>
										     ...
										     <input type="text"  name="nomPrimeVariable" id="nomPrimeVariable" path="nomPrimeVariable" class="form-control" />
										  </td>
										  </tr>
										   <tr>
										   ...
										   <td>Valeur (en DH) :</td>
										     ...
										     <input type="text"  name="valeurPrimeVariable" id="valeurPrimeVariable" path="valeurPrimeVariable" class="form-control" />
										  </td>
										  ...
										  <td>Imposable IR  :</td>
										     ...
										     <input type="checkbox"  name="imposableIR" id="imposableIR" path="imposableIR" class="form-control" />
										  </td>
										  </tr> 
										  
										     <tr>
										  <td>Imposable CNSS  :</td>
										      <td>
										    
										     <input type="checkbox"  name="imposableCNSS" id="imposableCNSS" path="imposableCNSS" class="form-control" />
										  </td>
										  </tr> 
										 
										    
										       <tr>
										  <td>Dans la Base d'ancienneté   :</td>
										      <td>
										    
										     <input type="checkbox"  name="baseAnciennete" id="baseAnciennete" path="baseAnciennete" class="form-control" />
										  </td>
										  </tr> 
										    
										    
										     <tr>
										  <td>Avantages en natures  :</td>
										      <td>
										     <input type="hidden"  id="idPrimeVariable" name="idPrimeVariable" path="idPrimeVariable"/>
										     <input type="checkbox"  name="avantagesNature" id="avantagesNature" path="avantagesNature" class="form-control" />
										  </td>
										  </tr> 
										    <tr>
										    <td>
    ...
    <div id="add-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="myModalLabel">Ajouter nouveaux paramètres d'IR</h4>
                </div>          
              ...
              <!-- my form to add -->
               ...
               <f:form action="ajouterPrimesPara" method="POST" modelAttribute="modelPrimesPara">
  ...
  <td>Primes:</td>
     ...
     <input name="nomPrimeVariable"  path="nomPrimeVariable"  class="form-control" />
  ...
  <td>Imposable IR  :</td>
     ...
     <input type="checkbox"  value="imposableIR" name="imposableIR" id="imposableIR" path="imposableIR" class="form-control" />
  ...
  <td>Imposable CNSS  :</td>
     ...
     <input type="checkbox" value="imposableCNSS" name="imposableCNSS" id="imposableCNSS" path="imposableCNSS" class="form-control" />
  ...
  <td>Dans la Base d'ancienneté   :</td>
     ...
     <input type="checkbox"  value="baseAnciennete" name="baseAnciennete" id="baseAnciennete" path="baseAnciennete" class="form-control" />
  ...
  <td>Avantages en natures  :</td>
      ...
      <td>
     <input type="checkbox"  value="avantagesNature" name="avantagesNature" id="avantagesNature" path="avantagesNature" class="form-control" />
...
<script>
        ...
        //	$modal.find('#idIgr').val('test');
            ...
            $.ajax({
                cache: false,
                type: 'GET',
                url: 'updatePrimesPara',
                data: {getId: esseyId},

                success: function(data) 
                {   
                	//$modal.find('#nomPrimeVariable').val();
                	//$('#nomPrimeVariable').html(data.nomPrimeVariable);
                	$modal.find('#nomPrimeVariable').val(data.nomPrimeVariable);
                    $modal.find('#idPrimeVariable').val(data.idPrimeVariable);
                    $modal.find('#valeurPrimeVariable').val(data.valeur);

                    
                if(data.imposableCNSS){
                	$('input:checkbox[name=imposableCNSS]').attr('checked',true);
                }
                if(data.imposableIR){
                	$('input:checkbox[name=imposableIR]').attr('checked',true);
                }
                if(data.baseAnciennete){
                	$('input:checkbox[name=baseAnciennete]').attr('checked',true);
                }
                if(data.avantagesNature){
                	$('input:checkbox[name=avantagesNature]').attr('checked',true);
                }
                }
            });
