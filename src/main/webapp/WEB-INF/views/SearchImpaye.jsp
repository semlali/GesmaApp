                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <p>Utiliser barre de recherch pour trouver les etudiant qui n'ont pas encore payer par nom.</p>
 
 <p>choisissez les coordonnées de l'étudiant</p>
 
                           
  <f:form method="get" action="rechercheParEtudiant"  class="form-horizontal" id="signup">                                  
                     ...
                     <tr>
                         ...
                         <td><input path="nomEtu" name="nomEtu" class="form-control"/> </td>
                         <td><label>Prénom</label></td>
                         <td><input path="prenomEtu" name="prenomEtu" class="form-control"/> </td>
