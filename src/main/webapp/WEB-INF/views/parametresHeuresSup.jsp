  ...
  <!-- START PAGE CONTAINER -->
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Gestion des heures supplémentaires</li>
                </ul>
                <!-- END BREADCRUMB -->  
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title">les paramètres des heures supplémentaires :</h3>
                                           ...
                                           <!-- Je me suis arrte ici -->       
                                                    ...
                                                    <c:forEach items="${profession}" var="i" >
        												<tr>
														     ...
														     <td><label class="col-md-3 control-label"  path="nomProfession" value="${i.nomProfession}" >${i.nomProfession}</label></td>
												 
												 		    
														   <td><a class="btn btn-default btn-rounded btn-sm"  data-toggle="modal" id="${i.idProfession}" data-target="#edit-modal" ><span class="fa fa-pencil"></span></a>
														     <a href="SupprimerHeuresSup?getIdToDelete=${i.idProfession}" class="btn btn-danger btn-rounded btn-sm" onclick="return confirm('Etes vous sur de vouloir supprimer cette ligne ?')"><span class="fa fa-times"></span></a>
														    </td>
    ...
    <div id="edit-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Modifier les paramètres des heures supplémentaire :</h4>
                </div>          
              
              
              
               <f:form method="post" name="form" action="validerUpdateHeuresSupParam" modelAttribute="modelHeuresSupPara" class="form-horizontal">
       ...
       <table>
										  ...
										  <td>Profession  :</td>
										      <td>
										     <input type="hidden" name="idProfession"  id="idProfession" path="idProfession" class="form-control"/>
										     <input type="text" name="nomProfession" id="nomProfession" path="nomProfession" class="form-control" />
										  </td>
										  </tr>
										   <tr>
										   
										   <td>Prix par heure lors d'un Ferié  (Matin) en DH  :</td>
										      <td>
										    
										     <input type="text"  name="prixJourFerierMatin" id="prixJourFerierMatin" path="prixJourFerierMatin" class="form-control" />
										  </td>
										   ...
										   <td>Prix par heure lors d'un Ferié  (Soir) en DH    :</td>
										      <td>
										    
										     <input type="text"  name="prixJourFerierSoir" id="prixJourFerierSoir" path="prixJourFerierSoir" class="form-control" />
										  </td>
										   
										   
										   </tr>
										   <tr>
										   <td>Prix par heure lors d'un jour Normal (Matin)  en DH   :</td>
										      <td>
										    
										     <input type="text"  name="prixJourNormalMatin" id="prixJourNormalMatin" path="prixJourNormalMatin" class="form-control" />
										  </td>
										   
										   
										   </tr>
										     <tr>
										   <td>Prix par heure lors d'un jour Normal (Soir)  en DH   :</td>
										      <td>
										    
										     <input type="text"  name="prixJourNormalSoir" id="prixJourNormalSoir" path="prixJourNormalSoir" class="form-control" />
										  </td>
...
<script>
        ...
        //	$modal.find('#idIgr').val('test');
            ...
            $.ajax({
                cache: false,
                type: 'POST',
                url: 'updateHeuresSupPara',
                data: {getId: esseyId},

                success: function(data) 
                {   
                	$modal.find('#nomProfession').val(data.nomProfession);
                	$modal.find('#idProfession').val(data.idProfession);
                	$modal.find('#prixJourFerierMatin').val(data.prixJourFerierMatin);
                	$modal.find('#prixJourFerierSoir').val(data.prixJourFerierSoir);
                	$modal.find('#prixJourNormalMatin').val(data.prixJourNormalMatin);
                	$modal.find('#prixJourNormalSoir').val(data.prixJourNormalSoir);
