        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Chercher une vehicule </li>
                </ul>
                <!-- END BREADCRUMB -->                       
           ...
           <!-- PAGE CONTENT WRAPPER -->
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                         <f:form class="form-horizontal" method="post" action="chargervehicule" modelAttribute="vehicule">
                            <!-- START SEARCH -->                            
                                    ...
                                    <div class="row stacked">
                                        <div class="col-md-6">
                                            <div class="input-group push-down-10">
                                                ...
                                                <input type="text" class="form-control" placeholder="Numéro d'immatriculation"  name="numImmatriculation"/>
                   ...
                   <c:if test="${not empty vehicule.numImmatriculation}">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default" align="center">
                                <div class="panel-body profile">
                                    <div class="profile-image">
                                        <img src="resources/assets/images/users/master-scolaire.jpg" alt="Nadia Ali"/>
                                    </div>
                                    <div class="profile-data">
                                        <div class="profile-data-name">Nom Chauffeur </div>
                                        <div class="profile-data-title">Chauffeur de la vehicule </div>
                                ...
                                <div class="panel-body" align="center">                                    
                                 ...
                                 <p><strong> Numéro d'immatriculation :</strong><br/>${vehicule.numImmatriculation}</p>
	
                                 <p><strong> La date de mise en service :</strong><br/>${vehicule.dateMiseEnService}</p>
	
                                  <p><strong> Nombre des années de service :</strong><br/>${vehicule.nbreAnneeService}</p>

                                    <p><strong>  Le poids total  :</strong><br/>${vehicule.poids_total}</p>
                                    
                                   <div class="sr-item">
                                   <p><strong><b>L'état de la vehicule :</b> </strong></p>
                                    <p><strong>  Roues  </strong><br/>${vehicule.etat_roue}</p>
                                     <p><strong> Siege </strong><br/>${vehicule.etat_siege}</p>
                                      <p><strong> Carosserie  </strong><br/>${vehicule.etat_carosserie}</p>
                                       <p><strong> Vitre </strong><br/>${vehicule.etat_vitre}</p>
                                </div> 
                                </div>
                                </div> 
